...
@router.get("/auth/google/login", response_model=schemas.GoogleAuthInitResponse)
async def google_oauth_login() -> schemas.GoogleAuthInitResponse:
    return await services.init_google_oauth()
